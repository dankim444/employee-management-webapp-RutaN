...
// This is the PopUp component that allows you to update individual information from 
// the employee management and portafolio page
export default function UpdateInfo2({ isOpen, handleClose }) {
